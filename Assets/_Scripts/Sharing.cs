...
using System.IO;
    ...
    public static class Sharing
    {
        ...
        /// <param name="subject">Subject.</param>
        public static void ShareImage(string filepath, string message, string subject = "")
        {
#if UNITY_EDITOR
            ...
            string chooserText = "Share With Friends";
            NativeShare.ShareAndroid(message, subject, null, filePaths, "image/png", true, chooserText);
#else
